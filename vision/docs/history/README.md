...
본 작품 vision 라인 (YOLO + 카메라 + 향후 fusion) 진행 중 **의사결정 / 마일스톤 / 자산 추가 / 환경 변경 / 측정 완료 / 멘토 피드백** 등 일반 진행 사항을 실시간 기록.
...
| 짧은 제목 | 영문 lowercase + underscore | `soak_test_8h_started`, `monorepo_migration`, `mentor_feedback_received` |
...
| 공식 100회 벤치 (멘토 06 JSON) | [`../docs/07_official_benchmark.md`](../docs/07_official_benchmark.md) |
