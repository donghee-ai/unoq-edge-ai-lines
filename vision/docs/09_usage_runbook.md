# Usage Runbook — Host and Device Common Commands
...
주의: `--serve` DEBUG ONLY. 인증 없음. 로컬 LAN 외부 노출 금지.
...
| `--jpeg-quality 70` | 70 | `--jpeg-quality 50`로 대역폭 / CPU 감소 |
...
상세 측정 결과 + 함정 진단 → `08_realtime_camera.md`.

## 10. 다음 작업 진입

이미 완료된 항목 (본 작품 합격선 통과까지):
