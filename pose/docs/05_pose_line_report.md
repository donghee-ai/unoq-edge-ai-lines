...
### 5-4. 카메라 PTZ — 물리적 보완 (2026-06-27 리뷰 미팅 후 확정)
...
| (폐기) | ~본체 자율 추적~ | 리뷰 미팅에서 본 작품 범위 외 — 모터/IMU 부담 회피 |
...
| 4 | **`--json` benchmark 저장** | 측정 자료 누적 + 벤치마크 표준 형식 |

### 7-2. 하드웨어 통합 (STM32U585 + 서보) — 2026-06-27 리뷰 미팅 후 확정
