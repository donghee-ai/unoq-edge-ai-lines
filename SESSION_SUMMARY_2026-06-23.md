...
> - **2026-06-24 후속**: ko/ (멘토 양식 트랙) 10개 신규 작성 후 docs/로 통합, 옛 docs 9개는 git history에만 보존. 최종 구조: `docs/{00 청사진, 01 host_env, 02 모델 선택, 03 규약, 04 device_setup, 05 initial_inference, 06 postprocess, 07 official_bench, 08 realtime_camera, 09 runbook, mentor/}` — 자세한 후속 흐름은 `SESSION_SUMMARY_2026-06-24.md` 참조
