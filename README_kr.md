# UNO Q Edge AI Lines (한국어)

> English: [`README.md`](README.md) · 이 문서가 원본이고 영문판이 번역본이다.
...
`imgsz=320`은 필수다 — `postprocess.py`가 320 입력(앵커 2100개) 전용으로 짜여 있고,
위의 9.23 FPS도 그 크기에서 잰 값이다.
